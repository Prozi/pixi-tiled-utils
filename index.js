...
function (_PIXI$Application) {
  ...
  function FullscreenApplication(everyTick, pixiApplicationOptions) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(FullscreenApplication).call(this, pixiApplicationOptions));
...
function (_FullscreenApplicatio) {
  _inherits(TiledApplication, _FullscreenApplicatio);

  function TiledApplication(everyTick, options) {
    _classCallCheck(this, TiledApplication);

    return _possibleConstructorReturn(this, _getPrototypeOf(TiledApplication).call(this, everyTick, options));
  }
